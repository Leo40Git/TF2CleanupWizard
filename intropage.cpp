...
IntroPage::IntroPage(QWidget *parent) : QWizardPage(parent)
{
    ...
    label = new QLabel("This wizard will reset your installation of Team Fortress 2 "
                       ...
                       "They will be moved to <code>TF2_FOLDER/tf/custom_backup/%1</code> and "
                       "<code>TF2_FOLDER/tf/cfg_backup/%1</code>, respectively. (Note that <i>the previous contents of these backup directories will be deleted.</i>)<br><br>"
...
{
    QString backupFolderName = QDateTime::currentDateTime().toString("MM/dd/yyyy-HH:mm");
    setProperty("backupFolderName", backupFolderName);
    label->setText(label->text().arg(backupFolderName));
}
